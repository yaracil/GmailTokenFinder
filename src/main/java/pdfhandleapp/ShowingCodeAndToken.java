...
import mygmailapi.GmailQuickstart;
...
//        
    ...
    public void gettingEmail() throws IOException, GeneralSecurityException {
        ...
        if (JOptionPane.showConfirmDialog(this, "REVIZAR CORREO?!?!?") == 0) {
